...
import { InsurancePolicyStatusRoutingModule } from './insurancePolicyStatus-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		InsurancePolicyStatusRoutingModule,
	],
	declarations: [
		InsurancePolicyStatusCreateComponent,
		InsurancePolicyStatusListComponent,
		InsurancePolicyStatusEditComponent,
		InsurancePolicyStatusViewComponent
	]
})
export class InsurancePolicyStatusModule { }
