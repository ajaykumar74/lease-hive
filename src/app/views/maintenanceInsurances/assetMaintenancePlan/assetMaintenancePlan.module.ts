...
import { AssetMaintenancePlanRoutingModule } from './assetMaintenancePlan-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetMaintenancePlanRoutingModule,
	],
	declarations: [
		AssetMaintenancePlanCreateComponent,
		AssetMaintenancePlanListComponent,
		AssetMaintenancePlanEditComponent,
		AssetMaintenancePlanViewComponent
	]
})
export class AssetMaintenancePlanModule { }
