...
import { MaintenanceInsuranceExceptionRoutingModule } from './maintenanceInsuranceException-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		MaintenanceInsuranceExceptionRoutingModule,
	],
	declarations: [
		MaintenanceInsuranceExceptionCreateComponent,
		MaintenanceInsuranceExceptionListComponent,
		MaintenanceInsuranceExceptionEditComponent,
		MaintenanceInsuranceExceptionViewComponent
	]
})
export class MaintenanceInsuranceExceptionModule { }
