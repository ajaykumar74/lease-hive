...
import { MaintenanceWorkOrderPartRoutingModule } from './maintenanceWorkOrderPart-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		MaintenanceWorkOrderPartRoutingModule,
	],
	declarations: [
		MaintenanceWorkOrderPartCreateComponent,
		MaintenanceWorkOrderPartListComponent,
		MaintenanceWorkOrderPartEditComponent,
		MaintenanceWorkOrderPartViewComponent
	]
})
export class MaintenanceWorkOrderPartModule { }
