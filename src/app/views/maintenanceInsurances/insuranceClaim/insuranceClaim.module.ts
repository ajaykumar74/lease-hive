...
import { InsuranceClaimRoutingModule } from './insuranceClaim-routing.module';
...
@NgModule({
	...
	declarations: [
		InsuranceClaimCreateComponent,
		InsuranceClaimListComponent,
		InsuranceClaimEditComponent,
		InsuranceClaimViewComponent
	]
})
