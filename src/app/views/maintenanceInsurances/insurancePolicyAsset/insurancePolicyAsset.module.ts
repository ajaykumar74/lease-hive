...
import { InsurancePolicyAssetRoutingModule } from './insurancePolicyAsset-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		InsurancePolicyAssetRoutingModule,
	],
	declarations: [
		InsurancePolicyAssetCreateComponent,
		InsurancePolicyAssetListComponent,
		InsurancePolicyAssetEditComponent,
		InsurancePolicyAssetViewComponent
	]
})
export class InsurancePolicyAssetModule { }
