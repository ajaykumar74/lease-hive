...
import { MaintenanceWorkOrderServiceRoutingModule } from './maintenanceWorkOrderService-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		MaintenanceWorkOrderServiceRoutingModule,
	],
	declarations: [
		MaintenanceWorkOrderServiceCreateComponent,
		MaintenanceWorkOrderServiceListComponent,
		MaintenanceWorkOrderServiceEditComponent,
		MaintenanceWorkOrderServiceViewComponent
	]
})
export class MaintenanceWorkOrderServiceModule { }
