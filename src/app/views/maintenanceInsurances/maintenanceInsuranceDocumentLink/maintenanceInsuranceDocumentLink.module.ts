...
import { MaintenanceInsuranceDocumentLinkRoutingModule } from './maintenanceInsuranceDocumentLink-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		MaintenanceInsuranceDocumentLinkRoutingModule,
	],
	declarations: [
		MaintenanceInsuranceDocumentLinkCreateComponent,
		MaintenanceInsuranceDocumentLinkListComponent,
		MaintenanceInsuranceDocumentLinkEditComponent,
		MaintenanceInsuranceDocumentLinkViewComponent
	]
})
export class MaintenanceInsuranceDocumentLinkModule { }
