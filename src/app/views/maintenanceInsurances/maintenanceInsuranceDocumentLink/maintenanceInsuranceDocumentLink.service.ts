...
export class MaintenanceInsuranceDocumentLinkService extends BaseCrudService<any> {
  ...
  constructor(protected override http: HttpClient, protected override baseService: BaseService) {
    ...
    this.baseUrl = this.baseService.C_APP_URL + '/MaintenanceInsuranceDocumentLinks';
