...
import { InsuranceClaimAssessmentRoutingModule } from './insuranceClaimAssessment-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		InsuranceClaimAssessmentRoutingModule,
	],
	declarations: [
		InsuranceClaimAssessmentCreateComponent,
		InsuranceClaimAssessmentListComponent,
		InsuranceClaimAssessmentEditComponent,
		InsuranceClaimAssessmentViewComponent
	]
})
export class InsuranceClaimAssessmentModule { }
