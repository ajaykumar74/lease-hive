...
@Component({
    templateUrl: './insuranceRenewal-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class InsuranceRenewalViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    insuranceRenewal: IInsuranceRenewal = {} as IInsuranceRenewal;
