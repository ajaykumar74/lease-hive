...
import { MaintenanceInsuranceHandoffRoutingModule } from './maintenanceInsuranceHandoff-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		MaintenanceInsuranceHandoffRoutingModule,
	],
	declarations: [
		MaintenanceInsuranceHandoffCreateComponent,
		MaintenanceInsuranceHandoffListComponent,
		MaintenanceInsuranceHandoffEditComponent,
		MaintenanceInsuranceHandoffViewComponent
	]
})
export class MaintenanceInsuranceHandoffModule { }
