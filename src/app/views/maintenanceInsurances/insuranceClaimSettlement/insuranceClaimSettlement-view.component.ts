...
@Component({
    templateUrl: './insuranceClaimSettlement-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class InsuranceClaimSettlementViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    insuranceClaimSettlement: IInsuranceClaimSettlement = {} as IInsuranceClaimSettlement;
