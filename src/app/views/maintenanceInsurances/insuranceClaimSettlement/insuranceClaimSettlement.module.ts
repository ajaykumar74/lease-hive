...
import { InsuranceClaimSettlementRoutingModule } from './insuranceClaimSettlement-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		InsuranceClaimSettlementRoutingModule,
	],
	declarations: [
		InsuranceClaimSettlementCreateComponent,
		InsuranceClaimSettlementListComponent,
		InsuranceClaimSettlementEditComponent,
		InsuranceClaimSettlementViewComponent
	]
})
export class InsuranceClaimSettlementModule { }
