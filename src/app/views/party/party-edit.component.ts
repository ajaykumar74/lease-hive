...
export class PartyEditComponent implements OnInit {
 ...
 this.menuItems = [
  ...
  onCommandClicked(key: string) {    
    if (key == "Documents") {
      this.router.navigate(['/dashboard/partyDocuments/party', this.party.Id]);
    }
    else if (key == "Roles") this.router.navigate(['/dashboard/partyRoles/party', this.party.Id]);
    else if (key == "GSTRegistrations") this.router.navigate(['/dashboard/partyGSTRegistrations/party', this.party.Id]);
    else if (key == "Locations") this.router.navigate(['/dashboard/partyLocations/party', this.party.Id]);
    else if (key == "Contacts") this.router.navigate(['/dashboard/partyContacts/party', this.party.Id]);
    else if (key == "BankAccounts") this.router.navigate(['/dashboard/partyBankAccounts/party', this.party.Id]);
    else if (key == "CreditProfiles") this.router.navigate(['/dashboard/partyCreditProfiles/party', this.party.Id]);
    else if (key == "CustomerProfile") this.router.navigate(['/dashboard/customerProfiles/party', this.party.Id]);
    else if (key == "SupplierProfile") this.router.navigate(['/dashboard/supplierProfiles/party', this.party.Id]);
  }
