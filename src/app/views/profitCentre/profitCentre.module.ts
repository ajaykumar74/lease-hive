...
import { ProfitCentreRoutingModule } from './profitCentre-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		ProfitCentreRoutingModule,
	],
	declarations: [
		ProfitCentreCreateComponent,
		ProfitCentreListComponent,
		ProfitCentreEditComponent,
		ProfitCentreViewComponent
	]
})
export class ProfitCentreModule { }
