...
import { ContractEventRoutingModule } from './contractEvent-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		ContractEventRoutingModule,
	],
	declarations: [
		ContractEventCreateComponent,
		ContractEventListComponent,
		ContractEventEditComponent,
		ContractEventViewComponent
	]
})
