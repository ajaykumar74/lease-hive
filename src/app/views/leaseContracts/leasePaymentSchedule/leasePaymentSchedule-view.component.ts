...
@Component({
    templateUrl: './leasePaymentSchedule-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class LeasePaymentScheduleViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    leasePaymentSchedule: ILeasePaymentSchedule = {} as ILeasePaymentSchedule;
