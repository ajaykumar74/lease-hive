...
import { LeaseAssetAllocationEventRoutingModule } from './leaseAssetAllocationEvent-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		LeaseAssetAllocationEventRoutingModule,
	],
	declarations: [
		LeaseAssetAllocationEventCreateComponent,
		LeaseAssetAllocationEventListComponent,
		LeaseAssetAllocationEventEditComponent,
		LeaseAssetAllocationEventViewComponent
	]
})
export class LeaseAssetAllocationEventModule { }
