...
import { ContractExecutionRoutingModule } from './contractExecution-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		ContractExecutionRoutingModule,
	],
	declarations: [
		ContractExecutionCreateComponent,
		ContractExecutionListComponent,
		ContractExecutionEditComponent,
		ContractExecutionViewComponent
	]
})
