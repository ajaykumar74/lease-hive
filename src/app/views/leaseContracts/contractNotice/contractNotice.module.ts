...
import { ContractNoticeRoutingModule } from './contractNotice-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		ContractNoticeRoutingModule,
	],
	declarations: [
		ContractNoticeCreateComponent,
		ContractNoticeListComponent,
		ContractNoticeEditComponent,
		ContractNoticeViewComponent
	]
})
export class ContractNoticeModule { }
