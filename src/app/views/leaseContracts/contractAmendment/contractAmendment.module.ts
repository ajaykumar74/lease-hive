...
import { ContractAmendmentRoutingModule } from './contractAmendment-routing.module';
...
@NgModule({
	...
	declarations: [
		ContractAmendmentCreateComponent,
		ContractAmendmentListComponent,
		ContractAmendmentEditComponent,
		ContractAmendmentViewComponent
	]
})
