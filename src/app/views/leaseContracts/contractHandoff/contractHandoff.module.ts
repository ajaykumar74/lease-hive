...
import { ContractHandoffRoutingModule } from './contractHandoff-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		ContractHandoffRoutingModule,
	],
	declarations: [
		ContractHandoffCreateComponent,
		ContractHandoffListComponent,
		ContractHandoffEditComponent,
		ContractHandoffViewComponent
	]
})
export class ContractHandoffModule { }
