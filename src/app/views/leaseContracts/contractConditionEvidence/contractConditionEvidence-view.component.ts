...
@Component({
    templateUrl: './contractConditionEvidence-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class ContractConditionEvidenceViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    contractConditionEvidence: IContractConditionEvidence = {} as IContractConditionEvidence;
