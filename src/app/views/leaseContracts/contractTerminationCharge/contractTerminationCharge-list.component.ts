...
export class ContractTerminationChargeListComponent implements OnInit {
  ...
  onDetailsClick(obj: any): void {
    if (this.permission.CanCreate || this.permission.CanUpdate) {
        this.router.navigate(['/contracts/terminations/charges/edit/' + obj.Id]);
    }
    else {
        this.router.navigate(['/contracts/terminations/charges/view/' + obj.Id]);
    } 
  ...
  onOptionItemClicked(key: string): void {
    if (key == "Create") {
      this.router.navigate(['/contracts/terminations/charges/create']);
    } 
    else if (key == "Refresh") {
      this.search();
    }
