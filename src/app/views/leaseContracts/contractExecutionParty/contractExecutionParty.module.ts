...
import { ContractExecutionPartyRoutingModule } from './contractExecutionParty-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		ContractExecutionPartyRoutingModule,
	],
	declarations: [
		ContractExecutionPartyCreateComponent,
		ContractExecutionPartyListComponent,
		ContractExecutionPartyEditComponent,
		ContractExecutionPartyViewComponent
	]
})
export class ContractExecutionPartyModule { }
