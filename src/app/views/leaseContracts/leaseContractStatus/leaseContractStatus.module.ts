...
import { LeaseContractStatusRoutingModule } from './leaseContractStatus-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		LeaseContractStatusRoutingModule,
	],
	declarations: [
		LeaseContractStatusCreateComponent,
		LeaseContractStatusListComponent,
		LeaseContractStatusEditComponent,
		LeaseContractStatusViewComponent
	]
})
export class LeaseContractStatusModule { }
