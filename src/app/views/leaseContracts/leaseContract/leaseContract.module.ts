...
import { LeaseContractRoutingModule } from './leaseContract-routing.module';
...
@NgModule({
	...
	declarations: [
		LeaseContractCreateComponent,
		LeaseContractListComponent,
		LeaseContractEditComponent,
		LeaseContractViewComponent
	]
})
