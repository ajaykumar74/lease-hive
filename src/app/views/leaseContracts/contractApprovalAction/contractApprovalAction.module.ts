...
import { ContractApprovalActionRoutingModule } from './contractApprovalAction-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		ContractApprovalActionRoutingModule,
	],
	declarations: [
		ContractApprovalActionCreateComponent,
		ContractApprovalActionListComponent,
		ContractApprovalActionEditComponent,
		ContractApprovalActionViewComponent
	]
})
export class ContractApprovalActionModule { }
