...
import { LeaseContractDocumentLinkRoutingModule } from './leaseContractDocumentLink-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		LeaseContractDocumentLinkRoutingModule,
	],
	declarations: [
		LeaseContractDocumentLinkCreateComponent,
		LeaseContractDocumentLinkListComponent,
		LeaseContractDocumentLinkEditComponent,
		LeaseContractDocumentLinkViewComponent
	]
})
export class LeaseContractDocumentLinkModule { }
