...
EffectiveTo:  obj.EffectiveTo || new Date(),
  ...
  onOptionItemClicked(key: string): void {
    if (key == "Create") {
      this.router.navigate(['/dashboard/partyLocations/create', { id: -1 }]);
    }
    else if (key == "Save") {
      this.Save();
    }
...
IsRegisteredOffice:  formValues.IsRegisteredOffice || null,
IsBillTo:  formValues.IsBillTo || null,
IsShipTo:  formValues.IsShipTo || null,
IsDefaultBillTo:  formValues.IsDefaultBillTo || null,
IsDefaultShipTo:  formValues.IsDefaultShipTo || null,
