...
import { OrganisationUnitLocationRoutingModule } from './organisationUnitLocation-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		OrganisationUnitLocationRoutingModule,
	],
	declarations: [
		OrganisationUnitLocationCreateComponent,
		OrganisationUnitLocationListComponent,
		OrganisationUnitLocationEditComponent,
		OrganisationUnitLocationViewComponent
	]
})
export class OrganisationUnitLocationModule { }
