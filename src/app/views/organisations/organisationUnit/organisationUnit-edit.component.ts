...
export class OrganisationUnitEditComponent implements OnInit {
  ...
  Save(): void {
    ...
    var updatedObj = {
      ...
      ParentOrganisationUnitId: formValues.ParentOrganisationUnitId || 0,
      ...
      ManagerUserId: formValues.ManagerUserId || 0,
      DefaultLocationId: formValues.DefaultLocationId || 0,
      IsContractingUnit: formValues.IsContractingUnit || false,
      IsBillingUnit: formValues.IsBillingUnit || false,
