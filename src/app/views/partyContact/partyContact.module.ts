...
import { PartyContactRoutingModule } from './partyContact-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		PartyContactRoutingModule,
	],
	declarations: [
		PartyContactCreateComponent,
		PartyContactListComponent,
		PartyContactEditComponent,
		PartyContactViewComponent
	]
})
export class PartyContactModule { }
