...
import { CustomerDepartmentRoutingModule } from './customerDepartment-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		CustomerDepartmentRoutingModule,
	],
	declarations: [
		CustomerDepartmentCreateComponent,
		CustomerDepartmentListComponent,
		CustomerDepartmentEditComponent,
		CustomerDepartmentViewComponent
	]
})
export class CustomerDepartmentModule { }
