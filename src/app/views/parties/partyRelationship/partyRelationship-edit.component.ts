...
EffectiveTo:  obj.EffectiveTo || new Date(),
  ...
  onOptionItemClicked(key: string): void {
    if (key == "Create") {
      this.router.navigate(['/business/parties/relationships/create', { id: -1 }]);
    }
    else if (key == "Save") {
      this.Save();
    }
...
EffectiveTo:  obj.EffectiveTo || new Date(),
  ...
  Save(): void {
     ...
     FromPartyId:  formValues.FromPartyId || 0,
ToPartyId:  formValues.ToPartyId || 0,
RelationshipType:  formValues.RelationshipType || null,
OwnershipPercentage:  formValues.OwnershipPercentage || 0,
