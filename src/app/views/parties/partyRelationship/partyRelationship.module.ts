...
import { PartyRelationshipRoutingModule } from './partyRelationship-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		PartyRelationshipRoutingModule,
	],
	declarations: [
		PartyRelationshipCreateComponent,
		PartyRelationshipListComponent,
		PartyRelationshipEditComponent,
		PartyRelationshipViewComponent
	]
})
