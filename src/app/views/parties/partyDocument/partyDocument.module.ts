...
import { PartyDocumentRoutingModule } from './partyDocument-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		PartyDocumentRoutingModule,
	],
	declarations: [
		PartyDocumentCreateComponent,
		PartyDocumentListComponent,
		PartyDocumentEditComponent,
		PartyDocumentViewComponent
	]
})
export class PartyDocumentModule { }
