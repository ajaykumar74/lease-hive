...
@Component({
    templateUrl: './customerProfile-view.component.html', 
standalone: false,
...
export class CustomerProfileViewComponent implements OnInit {
    ...
    customerProfile: ICustomerProfile = {} as ICustomerProfile;
    ...
    onOptionItemClicked(key: string): void {
        if (key == "Refresh") {             
            this.router.navigate(['/business/parties/customer-profiles/create']);
        }        
        else if (key == "Refresh") {
            this.loadUI();
        }
