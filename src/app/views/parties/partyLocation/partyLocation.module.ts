...
import { PartyLocationRoutingModule } from './partyLocation-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		PartyLocationRoutingModule,
	],
	declarations: [
		PartyLocationCreateComponent,
		PartyLocationListComponent,
		PartyLocationEditComponent,
		PartyLocationViewComponent
	]
})
export class PartyLocationModule { }
