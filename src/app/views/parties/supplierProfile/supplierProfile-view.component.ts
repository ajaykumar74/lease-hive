...
@Component({
    templateUrl: './supplierProfile-view.component.html', 
standalone: false,
...
export class SupplierProfileViewComponent implements OnInit {
    ...
    supplierProfile: ISupplierProfile = {} as ISupplierProfile;
    ...
    onOptionItemClicked(key: string): void {
        if (key == "Refresh") {             
            this.router.navigate(['/business/parties/supplier-profiles/create']);
        }        
        else if (key == "Refresh") {
            this.loadUI();
        }
