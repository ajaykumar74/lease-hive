...
import { VehicleAssetRoutingModule } from './vehicleAsset-routing.module';
...
@NgModule({
	...
	declarations: [
		VehicleAssetCreateComponent,
		VehicleAssetListComponent,
		VehicleAssetEditComponent,
		VehicleAssetViewComponent
	]
})
