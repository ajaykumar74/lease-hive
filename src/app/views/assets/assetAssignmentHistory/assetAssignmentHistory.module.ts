...
import { AssetAssignmentHistoryRoutingModule } from './assetAssignmentHistory-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetAssignmentHistoryRoutingModule,
	],
	declarations: [
		AssetAssignmentHistoryCreateComponent,
		AssetAssignmentHistoryListComponent,
		AssetAssignmentHistoryEditComponent,
		AssetAssignmentHistoryViewComponent
	]
})
export class AssetAssignmentHistoryModule { }
