...
import { AssetAttributeValueRoutingModule } from './assetAttributeValue-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetAttributeValueRoutingModule,
	],
	declarations: [
		AssetAttributeValueCreateComponent,
		AssetAttributeValueListComponent,
		AssetAttributeValueEditComponent,
		AssetAttributeValueViewComponent
	]
})
export class AssetAttributeValueModule { }
