...
import { AssetMeasureDefinitionRoutingModule } from './assetMeasureDefinition-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetMeasureDefinitionRoutingModule,
	],
	declarations: [
		AssetMeasureDefinitionCreateComponent,
		AssetMeasureDefinitionListComponent,
		AssetMeasureDefinitionEditComponent,
		AssetMeasureDefinitionViewComponent
	]
})
export class AssetMeasureDefinitionModule { }
