...
import { AssetIdentifierRoutingModule } from './assetIdentifier-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetIdentifierRoutingModule,
	],
	declarations: [
		AssetIdentifierCreateComponent,
		AssetIdentifierListComponent,
		AssetIdentifierEditComponent,
		AssetIdentifierViewComponent
	]
})
export class AssetIdentifierModule { }
