...
@Component({
    templateUrl: './assetAcquisition-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class AssetAcquisitionViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    assetAcquisition: IAssetAcquisition = {} as IAssetAcquisition;
