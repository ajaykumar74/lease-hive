...
import { AssetMakeRoutingModule } from './assetMake-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetMakeRoutingModule,
	],
	declarations: [
		AssetMakeCreateComponent,
		AssetMakeListComponent,
		AssetMakeEditComponent,
		AssetMakeViewComponent
	]
})
export class AssetMakeModule { }
