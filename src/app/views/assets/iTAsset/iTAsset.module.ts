...
import { ITAssetRoutingModule } from './iTAsset-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		ITAssetRoutingModule,
	],
	declarations: [
		ITAssetCreateComponent,
		ITAssetListComponent,
		ITAssetEditComponent,
		ITAssetViewComponent
	]
})
