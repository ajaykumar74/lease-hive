...
import { AssetValuationRoutingModule } from './assetValuation-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetValuationRoutingModule,
	],
	declarations: [
		AssetValuationCreateComponent,
		AssetValuationListComponent,
		AssetValuationEditComponent,
		AssetValuationViewComponent
	]
})
export class AssetValuationModule { }
