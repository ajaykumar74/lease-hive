...
import { AssetLocationHistoryRoutingModule } from './assetLocationHistory-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetLocationHistoryRoutingModule,
	],
	declarations: [
		AssetLocationHistoryCreateComponent,
		AssetLocationHistoryListComponent,
		AssetLocationHistoryEditComponent,
		AssetLocationHistoryViewComponent
	]
})
export class AssetLocationHistoryModule { }
