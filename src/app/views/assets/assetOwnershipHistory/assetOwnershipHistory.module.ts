...
import { AssetOwnershipHistoryRoutingModule } from './assetOwnershipHistory-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetOwnershipHistoryRoutingModule,
	],
	declarations: [
		AssetOwnershipHistoryCreateComponent,
		AssetOwnershipHistoryListComponent,
		AssetOwnershipHistoryEditComponent,
		AssetOwnershipHistoryViewComponent
	]
})
