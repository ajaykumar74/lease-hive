...
import { AssetLifecycleEventRoutingModule } from './assetLifecycleEvent-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetLifecycleEventRoutingModule,
	],
	declarations: [
		AssetLifecycleEventCreateComponent,
		AssetLifecycleEventListComponent,
		AssetLifecycleEventEditComponent,
		AssetLifecycleEventViewComponent
	]
})
export class AssetLifecycleEventModule { }
