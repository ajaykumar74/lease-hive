...
import { AssetMeasureReadingRoutingModule } from './assetMeasureReading-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetMeasureReadingRoutingModule,
	],
	declarations: [
		AssetMeasureReadingCreateComponent,
		AssetMeasureReadingListComponent,
		AssetMeasureReadingEditComponent,
		AssetMeasureReadingViewComponent
	]
})
export class AssetMeasureReadingModule { }
