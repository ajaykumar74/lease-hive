...
import { AssetDocumentLinkRoutingModule } from './assetDocumentLink-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetDocumentLinkRoutingModule,
	],
	declarations: [
		AssetDocumentLinkCreateComponent,
		AssetDocumentLinkListComponent,
		AssetDocumentLinkEditComponent,
		AssetDocumentLinkViewComponent
	]
})
export class AssetDocumentLinkModule { }
