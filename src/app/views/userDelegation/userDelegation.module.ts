...
import { UserDelegationRoutingModule } from './userDelegation-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		UserDelegationRoutingModule,
	],
	declarations: [
		UserDelegationCreateComponent,
		UserDelegationListComponent,
		UserDelegationEditComponent,
		UserDelegationViewComponent
	]
})
