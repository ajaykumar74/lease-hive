...
import { PurchaseOrderAmendmentRoutingModule } from './purchaseOrderAmendment-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		PurchaseOrderAmendmentRoutingModule,
	],
	declarations: [
		PurchaseOrderAmendmentCreateComponent,
		PurchaseOrderAmendmentListComponent,
		PurchaseOrderAmendmentEditComponent,
		PurchaseOrderAmendmentViewComponent
	]
})
export class PurchaseOrderAmendmentModule { }
