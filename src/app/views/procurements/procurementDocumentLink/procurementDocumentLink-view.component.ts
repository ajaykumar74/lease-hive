...
@Component({
    templateUrl: './procurementDocumentLink-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class ProcurementDocumentLinkViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    procurementDocumentLink: IProcurementDocumentLink = {} as IProcurementDocumentLink;
