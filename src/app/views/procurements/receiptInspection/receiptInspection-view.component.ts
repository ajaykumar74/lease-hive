...
@Component({
    templateUrl: './receiptInspection-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class ReceiptInspectionViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    receiptInspection: IReceiptInspection = {} as IReceiptInspection;
