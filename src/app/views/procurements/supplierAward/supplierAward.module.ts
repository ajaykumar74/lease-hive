...
import { SupplierAwardRoutingModule } from './supplierAward-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		SupplierAwardRoutingModule,
	],
	declarations: [
		SupplierAwardCreateComponent,
		SupplierAwardListComponent,
		SupplierAwardEditComponent,
		SupplierAwardViewComponent
	]
})
export class SupplierAwardModule { }
