...
@Component({
    templateUrl: './purchaseOrderStatus-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class PurchaseOrderStatusViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    purchaseOrderStatus: IPurchaseOrderStatus = {} as IPurchaseOrderStatus;
