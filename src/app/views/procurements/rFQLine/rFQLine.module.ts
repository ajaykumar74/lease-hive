...
import { RFQLineRoutingModule } from './rFQLine-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		RFQLineRoutingModule,
	],
	declarations: [
		RFQLineCreateComponent,
		RFQLineListComponent,
		RFQLineEditComponent,
		RFQLineViewComponent
	]
})
export class RFQLineModule { }
