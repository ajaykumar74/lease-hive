...
import { SupplierInvoiceLineRoutingModule } from './supplierInvoiceLine-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		SupplierInvoiceLineRoutingModule,
	],
	declarations: [
		SupplierInvoiceLineCreateComponent,
		SupplierInvoiceLineListComponent,
		SupplierInvoiceLineEditComponent,
		SupplierInvoiceLineViewComponent
	]
})
export class SupplierInvoiceLineModule { }
