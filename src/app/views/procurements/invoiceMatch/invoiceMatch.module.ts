...
import { InvoiceMatchRoutingModule } from './invoiceMatch-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		InvoiceMatchRoutingModule,
	],
	declarations: [
		InvoiceMatchCreateComponent,
		InvoiceMatchListComponent,
		InvoiceMatchEditComponent,
		InvoiceMatchViewComponent
	]
})
export class InvoiceMatchModule { }
