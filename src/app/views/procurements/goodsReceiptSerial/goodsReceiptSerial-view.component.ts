...
@Component({
    templateUrl: './goodsReceiptSerial-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class GoodsReceiptSerialViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    goodsReceiptSerial: IGoodsReceiptSerial = {} as IGoodsReceiptSerial;
