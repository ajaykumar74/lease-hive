...
export class ContactService extends BaseCrudService<any> {
  ...
  constructor(protected override http: HttpClient, protected override baseService: BaseService) {
    ...
    this.baseUrl = this.baseService.C_APP_URL + '/Contacts';
 ...
 search(  searchParam: any): Observable<any> {
   ...
   getContacts( customerId : number ): Observable<any> {
    const url = `${this.baseUrl}/GetContacts?RecordById=${customerId}&RecordByType=Customer`;
