...
import { AssetUserRoutingModule } from './assetUser-routing.module';
...
@NgModule({
	...
	declarations: [
		AssetUserCreateComponent,
		AssetUserListComponent,
		AssetUserEditComponent,
		AssetUserViewComponent
	]
})
export class AssetUserModule { }
