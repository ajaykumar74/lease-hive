...
export class PortalUserService extends BaseCrudService<any> {
  ...
  constructor(protected override http: HttpClient, protected override baseService: BaseService) {
    ...
    this.baseUrl = this.baseService.C_APP_URL + '/PortalUsers';
 ...
 search(  searchParam: any): Observable<any> {
  ...
  getCustomerAndPartner(  Id: number): Observable<any> {
    const url = `${this.baseUrl}/GetCustomerAndPartner/${Id}`;
