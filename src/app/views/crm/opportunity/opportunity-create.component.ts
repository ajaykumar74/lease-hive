...
this.owneruseridOptions.push({Text: 'User2', Value: 'User2' });
this.opportunitystageidOptions.push({Text: 'OpportunityStage1', Value: 'OpportunityStage1' });
this.opportunitystageidOptions.push({Text: 'OpportunityStage2', Value: 'OpportunityStage2' });
...
Description: obj.Description || '',
  ...
  onOptionItemClicked(key: string): void {
    if (key == "Create") {
      this.router.navigate(['/opportunitys/create']);
    }
    else if (key == "Save") {
      this.Save();
    }
