...
import { QuoteDiscountRoutingModule } from './quoteDiscount-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		QuoteDiscountRoutingModule,
	],
	declarations: [
		QuoteDiscountCreateComponent,
		QuoteDiscountListComponent,
		QuoteDiscountEditComponent,
		QuoteDiscountViewComponent
	]
})
export class QuoteDiscountModule { }
