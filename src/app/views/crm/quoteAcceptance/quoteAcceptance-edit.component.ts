...
this.acceptedbypartycontactidOptions.push({Text: 'PartContact1', Value: 'PartContact1' });
this.acceptedbypartycontactidOptions.push({Text: 'PartyContact2', Value: 'PartyContact2' });
