...
this.leaserequirementidOptions.push({Text: 'LeaseRequirementId1', Value: 'LeaseRequirementId1' });
this.leaserequirementidOptions.push({Text: 'LeaseRequirementId2', Value: 'LeaseRequirementId2' });
...
this.quotestatusidOptions.push({Text: 'Status1', Value: 'Status1' });
this.quotestatusidOptions.push({Text: 'Status2', Value: 'Status2' });
