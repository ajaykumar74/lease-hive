...
import { CreditConditionRoutingModule } from './creditCondition-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		CreditConditionRoutingModule,
	],
	declarations: [
		CreditConditionCreateComponent,
		CreditConditionListComponent,
		CreditConditionEditComponent,
		CreditConditionViewComponent
	]
})
