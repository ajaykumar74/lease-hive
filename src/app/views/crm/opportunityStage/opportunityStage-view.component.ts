...
@Component({
    templateUrl: './opportunityStage-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class OpportunityStageViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    opportunityStage: IOpportunityStage = {} as IOpportunityStage;
