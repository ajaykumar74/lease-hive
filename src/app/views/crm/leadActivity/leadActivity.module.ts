...
import { LeadActivityRoutingModule } from './leadActivity-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		LeadActivityRoutingModule,
	],
	declarations: [
		LeadActivityCreateComponent,
		LeadActivityListComponent,
		LeadActivityEditComponent,
		LeadActivityViewComponent
	]
})
