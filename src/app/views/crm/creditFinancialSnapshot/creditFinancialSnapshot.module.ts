...
import { CreditFinancialSnapshotRoutingModule } from './creditFinancialSnapshot-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		CreditFinancialSnapshotRoutingModule,
	],
	declarations: [
		CreditFinancialSnapshotCreateComponent,
		CreditFinancialSnapshotListComponent,
		CreditFinancialSnapshotEditComponent,
		CreditFinancialSnapshotViewComponent
	]
})
export class CreditFinancialSnapshotModule { }
