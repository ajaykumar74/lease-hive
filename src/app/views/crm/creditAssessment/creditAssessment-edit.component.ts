...
CurrencyCode: new FormControl('', [Validators.required, Validators.maxLength(20), ]),
   ...
   this.creditapplicationidOptions.push({Text: 'Application1', Value: 'Application1' });
this.creditapplicationidOptions.push({Text: 'Application2', Value: 'Application2' });
...
this.assessedbyuseridOptions.push({Text: 'User1', Value: 'User1' });
this.assessedbyuseridOptions.push({Text: 'User2', Value: 'User2' });
