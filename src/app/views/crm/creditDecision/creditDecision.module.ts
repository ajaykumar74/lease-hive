...
import { CreditDecisionRoutingModule } from './creditDecision-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		CreditDecisionRoutingModule,
	],
	declarations: [
		CreditDecisionCreateComponent,
		CreditDecisionListComponent,
		CreditDecisionEditComponent,
		CreditDecisionViewComponent
	]
})
