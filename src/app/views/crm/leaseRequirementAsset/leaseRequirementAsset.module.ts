...
import { LeaseRequirementAssetRoutingModule } from './leaseRequirementAsset-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		LeaseRequirementAssetRoutingModule,
	],
	declarations: [
		LeaseRequirementAssetCreateComponent,
		LeaseRequirementAssetListComponent,
		LeaseRequirementAssetEditComponent,
		LeaseRequirementAssetViewComponent
	]
})
export class LeaseRequirementAssetModule { }
