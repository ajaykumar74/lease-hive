...
import { QuoteTaxRoutingModule } from './quoteTax-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		QuoteTaxRoutingModule,
	],
	declarations: [
		QuoteTaxCreateComponent,
		QuoteTaxListComponent,
		QuoteTaxEditComponent,
		QuoteTaxViewComponent
	]
})
export class QuoteTaxModule { }
