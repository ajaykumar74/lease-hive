...
@Component({
    selector: 'app-quotePartySnapshot-create',
    standalone: false,
    templateUrl: './quotePartySnapshot-create.component.html',
    providers: [MessageService]
})
export class QuotePartySnapshotCreateComponent implements OnInit {
    selectedId: number;
    ...
    onOptionItemClicked(key: string): void {
        if (key == 'Create') {
            this.router.navigate(['/quotePartySnapshots/create']);
        } else if (key == 'Save') {
            this.Save();
        } else if (key == 'Cancel') {
            this.onCancel();
    ...
    Save(): void {
        ...
        this.spinner.show();
        this.quotePartySnapshotService.create(createdObj).subscribe({
            next: (data) => {
