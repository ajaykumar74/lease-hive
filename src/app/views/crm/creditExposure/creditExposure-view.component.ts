...
@Component({
    templateUrl: './creditExposure-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class CreditExposureViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    creditExposure: ICreditExposure = {} as ICreditExposure;
