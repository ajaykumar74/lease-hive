...
import { QuoteChargeRoutingModule } from './quoteCharge-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		QuoteChargeRoutingModule,
	],
	declarations: [
		QuoteChargeCreateComponent,
		QuoteChargeListComponent,
		QuoteChargeEditComponent,
		QuoteChargeViewComponent
	]
})
export class QuoteChargeModule { }
