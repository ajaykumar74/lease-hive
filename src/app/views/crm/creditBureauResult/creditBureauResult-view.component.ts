...
@Component({
    templateUrl: './creditBureauResult-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class CreditBureauResultViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    creditBureauResult: ICreditBureauResult = {} as ICreditBureauResult;
