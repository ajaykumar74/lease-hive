...
import { CreditApplicationStatusRoutingModule } from './creditApplicationStatus-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		CreditApplicationStatusRoutingModule,
	],
	declarations: [
		CreditApplicationStatusCreateComponent,
		CreditApplicationStatusListComponent,
		CreditApplicationStatusEditComponent,
		CreditApplicationStatusViewComponent
	]
})
export class CreditApplicationStatusModule { }
