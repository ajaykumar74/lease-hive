...
@Component({
    templateUrl: './creditApplicationStatus-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class CreditApplicationStatusViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    creditApplicationStatus: ICreditApplicationStatus = {} as ICreditApplicationStatus;
