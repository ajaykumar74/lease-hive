...
DelegatedFromUserId: new FormControl(0, [Validators.min(-2147483648), Validators.max(2147483647)]),
    ...
    this.approvalrequestidOptions.push({Text: 'Request1', Value: 'Request1' });
this.approvalrequestidOptions.push({Text: 'Request2', Value: 'Request2' });
this.approveruseridOptions.push({Text: 'Appuser1', Value: 'Appuser1' });
this.approveruseridOptions.push({Text: 'Appuser2', Value: 'Appuser2' });
...
this.delegatedfromuseridOptions.push({Text: 'Appuser1', Value: 'Appuser1' });
this.delegatedfromuseridOptions.push({Text: 'Appuser2', Value: 'Appuser2' });
