...
import { ApprovalActionRoutingModule } from './approvalAction-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		ApprovalActionRoutingModule,
	],
	declarations: [
		ApprovalActionCreateComponent,
		ApprovalActionListComponent,
		ApprovalActionEditComponent,
		ApprovalActionViewComponent
	]
})
export class ApprovalActionModule { }
