...
import { QuoteStatusRoutingModule } from './quoteStatus-routing.module';
...
@NgModule({
	...
	declarations: [
		QuoteStatusCreateComponent,
		QuoteStatusListComponent,
		QuoteStatusEditComponent,
		QuoteStatusViewComponent
	]
})
