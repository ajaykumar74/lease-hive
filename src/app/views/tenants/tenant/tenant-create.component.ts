...
this.numberformatOptions.push({Text: '#,##0.00', Value: '#,##0.00' });

this.financialyearstartmonthOptions.push({Text: 'January', Value: '1' });
this.financialyearstartmonthOptions.push({Text: 'February', Value: '2' });
this.financialyearstartmonthOptions.push({Text: 'March', Value: '3' });
this.financialyearstartmonthOptions.push({Text: 'April', Value: '4' });
this.financialyearstartmonthOptions.push({Text: 'May', Value: '5' });
