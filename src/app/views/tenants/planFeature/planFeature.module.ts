...
import { PlanFeatureRoutingModule } from './planFeature-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		PlanFeatureRoutingModule,
	],
	declarations: [
		PlanFeatureCreateComponent,
		PlanFeatureListComponent,
		PlanFeatureEditComponent,
		PlanFeatureViewComponent
	]
})
