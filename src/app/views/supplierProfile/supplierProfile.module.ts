...
import { SupplierProfileRoutingModule } from './supplierProfile-routing.module';
...
@NgModule({
	...
	declarations: [
		SupplierProfileCreateComponent,
		SupplierProfileListComponent,
		SupplierProfileEditComponent,
		SupplierProfileViewComponent
	]
})
