...
import { PartyCreditProfileRoutingModule } from './partyCreditProfile-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		PartyCreditProfileRoutingModule,
	],
	declarations: [
		PartyCreditProfileCreateComponent,
		PartyCreditProfileListComponent,
		PartyCreditProfileEditComponent,
		PartyCreditProfileViewComponent
	]
})
export class PartyCreditProfileModule { }
