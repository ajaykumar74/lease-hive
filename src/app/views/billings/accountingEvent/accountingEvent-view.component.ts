...
@Component({
    templateUrl: './accountingEvent-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class AccountingEventViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    accountingEvent: IAccountingEvent = {} as IAccountingEvent;
