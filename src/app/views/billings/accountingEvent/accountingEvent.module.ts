...
import { AccountingEventRoutingModule } from './accountingEvent-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AccountingEventRoutingModule,
	],
	declarations: [
		AccountingEventCreateComponent,
		AccountingEventListComponent,
		AccountingEventEditComponent,
		AccountingEventViewComponent
	]
})
export class AccountingEventModule { }
