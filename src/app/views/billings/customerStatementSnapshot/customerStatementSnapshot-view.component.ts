...
@Component({
    templateUrl: './customerStatementSnapshot-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class CustomerStatementSnapshotViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    customerStatementSnapshot: ICustomerStatementSnapshot = {} as ICustomerStatementSnapshot;
