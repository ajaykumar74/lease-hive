...
import { FinanceApprovalRequestRoutingModule } from './financeApprovalRequest-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		FinanceApprovalRequestRoutingModule,
	],
	declarations: [
		FinanceApprovalRequestCreateComponent,
		FinanceApprovalRequestListComponent,
		FinanceApprovalRequestEditComponent,
		FinanceApprovalRequestViewComponent
	]
})
export class FinanceApprovalRequestModule { }
