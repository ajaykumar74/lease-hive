...
import { CustomerDepositRoutingModule } from './customerDeposit-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		CustomerDepositRoutingModule,
	],
	declarations: [
		CustomerDepositCreateComponent,
		CustomerDepositListComponent,
		CustomerDepositEditComponent,
		CustomerDepositViewComponent
	]
})
