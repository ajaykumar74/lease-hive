...
@Component({
    templateUrl: './financeHandoff-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class FinanceHandoffViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    financeHandoff: IFinanceHandoff = {} as IFinanceHandoff;
