...
@Component({
    templateUrl: './billingRunItem-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class BillingRunItemViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    billingRunItem: IBillingRunItem = {} as IBillingRunItem;
