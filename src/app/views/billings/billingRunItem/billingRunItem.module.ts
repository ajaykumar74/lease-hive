...
import { BillingRunItemRoutingModule } from './billingRunItem-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		BillingRunItemRoutingModule,
	],
	declarations: [
		BillingRunItemCreateComponent,
		BillingRunItemListComponent,
		BillingRunItemEditComponent,
		BillingRunItemViewComponent
	]
})
export class BillingRunItemModule { }
