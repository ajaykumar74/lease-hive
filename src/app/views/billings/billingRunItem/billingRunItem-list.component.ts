...
export class BillingRunItemListComponent implements OnInit {
  ...
  onDetailsClick(obj: any): void {
    if (this.permission.CanCreate || this.permission.CanUpdate) {
        this.router.navigate(['dashboard/billingRunItems/edit/' + obj.Id]);
    }
    else {
        this.router.navigate(['dashboard/billingRunItems/view/' + obj.Id]);
    } 
  ...
  onOptionItemClicked(key: string): void {
    if (key == "Create") {
      this.router.navigate(['dashboard/billingRunItems/create']);
    } 
    else if (key == "Refresh") {
      this.search();
    }
