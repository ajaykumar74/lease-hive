...
import { JournalEntryLineRoutingModule } from './journalEntryLine-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		JournalEntryLineRoutingModule,
	],
	declarations: [
		JournalEntryLineCreateComponent,
		JournalEntryLineListComponent,
		JournalEntryLineEditComponent,
		JournalEntryLineViewComponent
	]
})
