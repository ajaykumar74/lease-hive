...
import { FinanceDocumentLinkRoutingModule } from './financeDocumentLink-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		FinanceDocumentLinkRoutingModule,
	],
	declarations: [
		FinanceDocumentLinkCreateComponent,
		FinanceDocumentLinkListComponent,
		FinanceDocumentLinkEditComponent,
		FinanceDocumentLinkViewComponent
	]
})
export class FinanceDocumentLinkModule { }
