...
@Component({
    templateUrl: './customerInvoiceLine-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class CustomerInvoiceLineViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    customerInvoiceLine: ICustomerInvoiceLine = {} as ICustomerInvoiceLine;
