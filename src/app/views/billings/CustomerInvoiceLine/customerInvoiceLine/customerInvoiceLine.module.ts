...
import { CustomerInvoiceLineRoutingModule } from './customerInvoiceLine-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		CustomerInvoiceLineRoutingModule,
	],
	declarations: [
		CustomerInvoiceLineCreateComponent,
		CustomerInvoiceLineListComponent,
		CustomerInvoiceLineEditComponent,
		CustomerInvoiceLineViewComponent
	]
})
export class CustomerInvoiceLineModule { }
