...
import { BillingRunRoutingModule } from './billingRun-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		BillingRunRoutingModule,
	],
	declarations: [
		BillingRunCreateComponent,
		BillingRunListComponent,
		BillingRunEditComponent,
		BillingRunViewComponent
	]
})
