...
import { PaymentAllocationRoutingModule } from './paymentAllocation-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		PaymentAllocationRoutingModule,
	],
	declarations: [
		PaymentAllocationCreateComponent,
		PaymentAllocationListComponent,
		PaymentAllocationEditComponent,
		PaymentAllocationViewComponent
	]
})
