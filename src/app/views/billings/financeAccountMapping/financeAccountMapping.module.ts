...
import { FinanceAccountMappingRoutingModule } from './financeAccountMapping-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		FinanceAccountMappingRoutingModule,
	],
	declarations: [
		FinanceAccountMappingCreateComponent,
		FinanceAccountMappingListComponent,
		FinanceAccountMappingEditComponent,
		FinanceAccountMappingViewComponent
	]
})
