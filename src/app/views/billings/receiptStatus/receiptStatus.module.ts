...
import { ReceiptStatusRoutingModule } from './receiptStatus-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		ReceiptStatusRoutingModule,
	],
	declarations: [
		ReceiptStatusCreateComponent,
		ReceiptStatusListComponent,
		ReceiptStatusEditComponent,
		ReceiptStatusViewComponent
	]
})
export class ReceiptStatusModule { }
