...
import { BillingRunStatusRoutingModule } from './billingRunStatus-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		BillingRunStatusRoutingModule,
	],
	declarations: [
		BillingRunStatusCreateComponent,
		BillingRunStatusListComponent,
		BillingRunStatusEditComponent,
		BillingRunStatusViewComponent
	]
})
export class BillingRunStatusModule { }
