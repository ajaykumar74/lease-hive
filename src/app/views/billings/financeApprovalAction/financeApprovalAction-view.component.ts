...
@Component({
    templateUrl: './financeApprovalAction-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class FinanceApprovalActionViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    financeApprovalAction: IFinanceApprovalAction = {} as IFinanceApprovalAction;
