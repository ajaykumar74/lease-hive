...
import { UserOrganisationUnitRoutingModule } from './userOrganisationUnit-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		UserOrganisationUnitRoutingModule,
	],
	declarations: [
		UserOrganisationUnitCreateComponent,
		UserOrganisationUnitListComponent,
		UserOrganisationUnitEditComponent,
		UserOrganisationUnitViewComponent
	]
})
export class UserOrganisationUnitModule { }
