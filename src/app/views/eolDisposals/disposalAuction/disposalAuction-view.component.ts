...
@Component({
    templateUrl: './disposalAuction-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class DisposalAuctionViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    disposalAuction: IDisposalAuction = {} as IDisposalAuction;
