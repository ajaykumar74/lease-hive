...
@Component({
    templateUrl: './disposalValuationReference-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class DisposalValuationReferenceViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    disposalValuationReference: IDisposalValuationReference = {} as IDisposalValuationReference;
