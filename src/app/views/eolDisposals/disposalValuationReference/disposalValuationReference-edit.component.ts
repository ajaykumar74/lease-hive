...
RecordStatus: obj.RecordStatus || '',
  ...
  onOptionItemClicked(key: string): void {
    if (key == "Create") {
      this.router.navigate(['/disposalValuationReference/create', { id: -1 }]);
    }
    else if (key == "Save") {
      this.Save();
    }
...
AssetValuationId:  formValues.AssetValuationId || null,
ReferenceDate:  formValues.ReferenceDate || null,
MarketValueAmount:  formValues.MarketValueAmount || null,
ReserveAmount:  formValues.ReserveAmount || null,
TargetAmount:  formValues.TargetAmount || null,
