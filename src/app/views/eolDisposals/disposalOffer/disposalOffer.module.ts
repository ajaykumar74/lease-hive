...
import { DisposalOfferRoutingModule } from './disposalOffer-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		DisposalOfferRoutingModule,
	],
	declarations: [
		DisposalOfferCreateComponent,
		DisposalOfferListComponent,
		DisposalOfferEditComponent,
		DisposalOfferViewComponent
	]
})
export class DisposalOfferModule { }
