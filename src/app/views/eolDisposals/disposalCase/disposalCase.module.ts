...
import { DisposalCaseRoutingModule } from './disposalCase-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		DisposalCaseRoutingModule,
	],
	declarations: [
		DisposalCaseCreateComponent,
		DisposalCaseListComponent,
		DisposalCaseEditComponent,
		DisposalCaseViewComponent
	]
})
export class DisposalCaseModule { }
