...
@Component({
    templateUrl: './dispositionMethod-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class DispositionMethodViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    dispositionMethod: IDispositionMethod = {} as IDispositionMethod;
