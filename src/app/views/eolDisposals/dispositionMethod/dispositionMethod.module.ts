...
import { DispositionMethodRoutingModule } from './dispositionMethod-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		DispositionMethodRoutingModule,
	],
	declarations: [
		DispositionMethodCreateComponent,
		DispositionMethodListComponent,
		DispositionMethodEditComponent,
		DispositionMethodViewComponent
	]
})
export class DispositionMethodModule { }
