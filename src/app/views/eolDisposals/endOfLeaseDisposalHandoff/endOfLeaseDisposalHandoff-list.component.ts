...
export class EndOfLeaseDisposalHandoffListComponent implements OnInit {
  ...
  onDetailsClick(obj: any): void {
    if (this.permission.CanCreate || this.permission.CanUpdate) {
        this.router.navigate(['/eol-disposal/handoffs/edit/' + obj.Id]);
    }
    else {
        this.router.navigate(['/eol-disposal/handoffs/view/' + obj.Id]);
    } 
  ...
  onOptionItemClicked(key: string): void {
    if (key == "Create") {
      this.router.navigate(['/eol-disposal/handoffs/create']);
    } 
    else if (key == "Refresh") {
      this.search();
    }
