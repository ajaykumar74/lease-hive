...
import { EndOfLeaseDisposalExceptionRoutingModule } from './endOfLeaseDisposalException-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		EndOfLeaseDisposalExceptionRoutingModule,
	],
	declarations: [
		EndOfLeaseDisposalExceptionCreateComponent,
		EndOfLeaseDisposalExceptionListComponent,
		EndOfLeaseDisposalExceptionEditComponent,
		EndOfLeaseDisposalExceptionViewComponent
	]
})
export class EndOfLeaseDisposalExceptionModule { }
