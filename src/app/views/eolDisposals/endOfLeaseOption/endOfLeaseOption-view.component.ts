...
@Component({
    templateUrl: './endOfLeaseOption-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class EndOfLeaseOptionViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    endOfLeaseOption: IEndOfLeaseOption = {} as IEndOfLeaseOption;
