...
import { RefurbishmentHandoffRoutingModule } from './refurbishmentHandoff-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		RefurbishmentHandoffRoutingModule,
	],
	declarations: [
		RefurbishmentHandoffCreateComponent,
		RefurbishmentHandoffListComponent,
		RefurbishmentHandoffEditComponent,
		RefurbishmentHandoffViewComponent
	]
})
export class RefurbishmentHandoffModule { }
