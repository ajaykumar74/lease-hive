...
import { SupplierReturnRoutingModule } from './supplierReturn-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		SupplierReturnRoutingModule,
	],
	declarations: [
		SupplierReturnCreateComponent,
		SupplierReturnListComponent,
		SupplierReturnEditComponent,
		SupplierReturnViewComponent
	]
})
