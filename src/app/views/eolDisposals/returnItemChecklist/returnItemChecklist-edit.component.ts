...
RecordStatus: obj.RecordStatus || '',
  ...
  onOptionItemClicked(key: string): void {
    if (key == "Create") {
      this.router.navigate(['/returnItemChecklist/create', { id: -1 }]);
    }
    else if (key == "Save") {
      this.Save();
    }
...
ExpectedQuantity:  formValues.ExpectedQuantity || null,
ReturnedQuantity:  formValues.ReturnedQuantity || null,
