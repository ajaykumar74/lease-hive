...
export class ReturnItemChecklistListComponent implements OnInit {
  ...
  onDetailsClick(obj: any): void {
    if (this.permission.CanCreate || this.permission.CanUpdate) {
        this.router.navigate(['dashboard/returnItemChecklists/edit/' + obj.Id]);
    }
    else {
        this.router.navigate(['dashboard/returnItemChecklists/view/' + obj.Id]);
    } 
  ...
  onOptionItemClicked(key: string): void {
    if (key == "Create") {
      this.router.navigate(['dashboard/returnItemChecklists/create']);
    } 
    else if (key == "Refresh") {
      this.search();
    }
