...
import { EndOfLeaseCaseRoutingModule } from './endOfLeaseCase-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		EndOfLeaseCaseRoutingModule,
	],
	declarations: [
		EndOfLeaseCaseCreateComponent,
		EndOfLeaseCaseListComponent,
		EndOfLeaseCaseEditComponent,
		EndOfLeaseCaseViewComponent
	]
})
export class EndOfLeaseCaseModule { }
