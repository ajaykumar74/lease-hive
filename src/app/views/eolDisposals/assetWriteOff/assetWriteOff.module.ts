...
import { AssetWriteOffRoutingModule } from './assetWriteOff-routing.module';
...
@NgModule({
	...
	declarations: [
		AssetWriteOffCreateComponent,
		AssetWriteOffListComponent,
		AssetWriteOffEditComponent,
		AssetWriteOffViewComponent
	]
})
