...
@Component({
  selector: 'app-endOfLeaseStatus-create',
  standalone: false,
  templateUrl: './endOfLeaseStatus-create.component.html' ,
   providers: [ MessageService]
})
export class EndOfLeaseStatusCreateComponent implements OnInit {
...
RecordStatus: obj.RecordStatus || '',
  ...
  onOptionItemClicked(key: string): void {
    if (key == "Create") {
      this.router.navigate(['/endOfLeaseStatuss/create']);
    }
    else if (key == "Save") {
      this.Save();
    }
...
RecordStatus: formValues.RecordStatus || null,
	  ...
	  this.spinner.show(); 
    this.endOfLeaseStatusService.create(createdObj).subscribe({
      next: data => {	   
