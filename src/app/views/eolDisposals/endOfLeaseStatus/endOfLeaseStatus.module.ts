...
import { EndOfLeaseStatusRoutingModule } from './endOfLeaseStatus-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		EndOfLeaseStatusRoutingModule,
	],
	declarations: [
		EndOfLeaseStatusCreateComponent,
		EndOfLeaseStatusListComponent,
		EndOfLeaseStatusEditComponent,
		EndOfLeaseStatusViewComponent
	]
})
export class EndOfLeaseStatusModule { }
