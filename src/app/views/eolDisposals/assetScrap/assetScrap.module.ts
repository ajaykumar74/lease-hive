...
import { AssetScrapRoutingModule } from './assetScrap-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetScrapRoutingModule,
	],
	declarations: [
		AssetScrapCreateComponent,
		AssetScrapListComponent,
		AssetScrapEditComponent,
		AssetScrapViewComponent
	]
})
export class AssetScrapModule { }
