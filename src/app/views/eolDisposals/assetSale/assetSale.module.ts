...
import { AssetSaleRoutingModule } from './assetSale-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetSaleRoutingModule,
	],
	declarations: [
		AssetSaleCreateComponent,
		AssetSaleListComponent,
		AssetSaleEditComponent,
		AssetSaleViewComponent
	]
})
export class AssetSaleModule { }
