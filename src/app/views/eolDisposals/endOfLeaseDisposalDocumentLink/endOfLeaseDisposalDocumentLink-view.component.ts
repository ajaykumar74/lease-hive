...
@Component({
    templateUrl: './endOfLeaseDisposalDocumentLink-view.component.html', 
standalone: false,
    providers: [MessageService]
})
export class EndOfLeaseDisposalDocumentLinkViewComponent implements OnInit {
    selectedId: number;
    isLoading: boolean = false;
    permission = { CanCreate: true } as IPermission;
    endOfLeaseDisposalDocumentLink: IEndOfLeaseDisposalDocumentLink = {} as IEndOfLeaseDisposalDocumentLink;
