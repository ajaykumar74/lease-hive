...
import { AssetReturnRoutingModule } from './assetReturn-routing.module';
...
@NgModule({
	imports: [
		...
		MySharedModule, 
		FluidModule,
		AssetReturnRoutingModule,
	],
	declarations: [
		AssetReturnCreateComponent,
		AssetReturnListComponent,
		AssetReturnEditComponent,
		AssetReturnViewComponent
	]
})
