...
RecordStatus: obj.RecordStatus || '',
  ...
  onOptionItemClicked(key: string): void {
    if (key == "Create") {
      this.router.navigate(['/returnAssessmentDamage/create', { id: -1 }]);
    }
    else if (key == "Save") {
      this.Save();
    }
...
InspectionItemReferenceId:  formValues.InspectionItemReferenceId || null,
DamageCode:  formValues.DamageCode || null,
DamageDescription:  formValues.DamageDescription || null,
ChargeableFlag:  formValues.ChargeableFlag || null,
EstimatedRepairAmount:  formValues.EstimatedRepairAmount || null,
ApprovedChargeAmount:  formValues.ApprovedChargeAmount || null,
